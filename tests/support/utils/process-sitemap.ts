...
/**
 * Recursively fetches and parses a sitemap or sitemap index into URL entries.
 *
 * @param sitemapUrl URL of a sitemap XML document.
 * @param counts Optional accumulator of per-sitemap URL counts.
 * @returns Flattened URL list and updated count map.
 */
